...
#define STRING_CONFIG_H_AUTHOR "(tharr916, Timothy Harrington)" // Who made the changes.
 ...
 */
#define BAUDRATE 115200  // default was 250000
...
#define CUSTOM_MACHINE_NAME "MyMaker"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "4804786a-9b5e-11e9-a2a3-2a2ae2dbcce4"
 ...
 * 
 * X-axis: Creality 42-34 Motor 1.8 degree
 * Y-axis: Creality 42-34 Motor 1.8 degree
 * Z-axis: Creality 42-34 Motor 1.8 degree
 * E-axis: Usongshine 42-23 17HS4023 Motor 1.8 degree    E3D Tough Extruder (3:1 gearing)
 ...
 */
 ...
 #define STEPS_PER_REVOLUTION_E (200.0 * 32.0) // 1.8° motor
 
 #define IDLER_TEETH_X 20.0
 #define IDLER_TEETH_Y 20.0
 
 // GT2 belt with 2mm pitch
 #define BELT_PITCH_X 2.0
 #define BELT_PITCH_Y 2.0
 
 // T8 trapezoidal 8mm lead, 4 start, 2mm pitch leadscrew
 #define LEAD_OF_Z_ROD 8.00
 
 // makergear extruder box
 #define EXTRUDER_GEAR_RATIO 3.0
 
 #define HOBB_WHEEL_DIAMETER 6.57001 //<--calculated val, original per specs: 7.3 
 
 #define PI_FOR_OUR_PURPOSES 3.141592
 
 #define AXIS_STEPS_PER_UNIT_X (STEPS_PER_REVOLUTION_X / IDLER_TEETH_X / BELT_PITCH_X) /// 320
 #define AXIS_STEPS_PER_UNIT_Y (STEPS_PER_REVOLUTION_Y / IDLER_TEETH_Y / BELT_PITCH_Y) /// 160
 #define AXIS_STEPS_PER_UNIT_Z (STEPS_PER_REVOLUTION_Z / LEAD_OF_Z_ROD) // 800
 #define AXIS_STEPS_PER_UNIT_E (STEPS_PER_REVOLUTION_E * EXTRUDER_GEAR_RATIO / (HOBB_WHEEL_DIAMETER * PI_FOR_OUR_PURPOSES))  // 930.22 <-- measured, original: 837.1987
 ...
 */
#define DEFAULT_ACCELERATION          1250 // old 500    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1250    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1250 // old 500    // X, Y, Z acceleration for travel (non printing) moves
...
#define DEFAULT_EJERK    5.0  // May be used by Linear Advance // testing 3
