...
#define LIN_ADVANCE 
  ...
  #define LIN_ADVANCE_K 0 // 0.1 seems to be working well currently   // Unit: mm compression per 1mm/s extruder speed
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MINIMUM_STEPPER_PULSE 1  //needed to get the extruder to work with the tmc2130
 ...
 */
  ...
  // Wetterot 17HM3410 42-34, 0.9 degree, 1.7A max @ 80% = 1.36
  #if AXIS_IS_TMC(X)
  ...
  // Creality 42-34 Motor 1.8 degree, Current should ideally be < 0.84A (85% of 1A max)
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT     700 //760 // <-- previous
  ...
  // 2 x Creality 42-34 Motor 1.8 degree, Current should ideally be < 0.84A (85% of 1A max) 
  // Connected using Y-cable
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT     800 //760 // <-- previous
  ...
  // Usongshine 42-23 17HS4023 1.8 deg. step angle(200 steps/rev) Current should ideally be < 0.84A (85% of 1A max) , resistance 3.5ohms
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT    800 //900  // <-- previous
