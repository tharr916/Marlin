 ...
 */
#define E0_AUTO_FAN_PIN P2_04 // same value as defined within 'pins_BTT_SKR_common.h'
...
#define LCD_SET_PROGRESS_MANUALLY // pair with the M73 Progress plugin for OctoPrint: https://plugins.octoprint.org/plugins/m73progress/
 ...
 */
  ...
  #if AXIS_IS_TMC(X)        // Wetterot 17HM3410 42-34, 0.9 degree, 1.7A max @ 80% = 1.36
  ...
  #if AXIS_IS_TMC(Y)        // Creality 42-34 Motor 1.8 degree, Current should ideally be < 0.84A (85% of 1A max)
  ...
  #if AXIS_IS_TMC(Z)        // (Y-cable) 2 x Creality 42-34 Motor 1.8 degree, Current should ideally be < 0.84A (85% of 1A max)
  ...
  #if AXIS_IS_TMC(E0)       // Usongshine 42-23 17HS4023 1.8 deg. step angle(200 steps/rev) Current should ideally be < 0.84A (85% of 1A max) , resistance 3.5ohms
